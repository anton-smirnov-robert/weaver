...
The proposed model can be summarized as follows. A finite set of economic actors are all inclined to consume or produce a different finite set of goods. This parametrizes their field of visions which need to overlap one another (T1). The state of those actors is described by their variable consumption and production of goods. The state of the latter is their variable price (T2). Their flexibility is parametrized.

Hayek's main idea is that to reach the equilibrium of the global economy, local actors only need know how to differentiate their local consumption or production of goods 

given the knowledge they have, "which by its nature cannot enter into statistics and therefore cannot be conveyed to any central authority in statistical form". 

Therefore, as long as people act to maximize their own benefit, the _price mechanism_ channels information (reduced to digits) between individuals whose fields of vision sufficiently overlap, and gives _instructions_. If the price of this commodity increases, I reduce my consumption of it and buy more of similar but different ones. 
