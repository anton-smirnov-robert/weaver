...
The merit of the provocative view is to contrast with the mainstream belief that looks for invariants in biology. Now that irreproducibility is no longer a taboo ([Baker2016](reference/Baker2016.md)) in biology in
...
Arguing that biological knowledge should be generalizable
measurement
measurements in biology must be justified[Clark2017](reference/Clark2017.md)
