...
- La spécificité du savoir générer s'ignore quand elle prend ses théories, trop longtemps restées indemnes, pour dogmatismes. Or si ses théories sont invariantes dans le temps, la science n'est plus un processus historique. Quand une génération n'assiste pas à des techtoniques des plaques, l'on perd de vue l'idée que des renversements peuvent s'opérer. 

- Automatise, entropique et moyenne et automatisme: disruption de second-ordre, perte de possibilité de créer de l'anti-entropie.  
...
- Radicalement impréscriptible et utile. 
